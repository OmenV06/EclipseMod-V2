...
public class FirewaveSmallParticle extends TextureSheetParticle {

    private final SpriteSet sprites;

    protected FirewaveSmallParticle(ClientLevel level, double x, double y, double z, double dx, double dy, double dz, SpriteSet sprites) {
    ...
    @OnlyIn(Dist.CLIENT)
    public static class FirewaveSmallParticleFactory implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public FirewaveSmallParticleFactory(SpriteSet spriteSet) {
            this.spriteSet = spriteSet;
        }

        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double dx, double dy, double dz) {
            return new FirewaveSmallParticle(level, x, y, z, dx, dy, dz, spriteSet);
        }
    }
