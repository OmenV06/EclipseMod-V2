...
public class FirewaveMediumParticle extends TextureSheetParticle {

    private final SpriteSet sprites;

    protected FirewaveMediumParticle(ClientLevel level, double x, double y, double z, double dx, double dy, double dz, SpriteSet sprites) {
    ...
    @OnlyIn(Dist.CLIENT)
    public static class FirewaveMediumParticleFactory implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public FirewaveMediumParticleFactory(SpriteSet spriteSet) {
            this.spriteSet = spriteSet;
        }

        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double dx, double dy, double dz) {
            return new FirewaveMediumParticle(level, x, y, z, dx, dy, dz, spriteSet);
        }
    }
